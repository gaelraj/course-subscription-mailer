package com.school.mailer.endpoint.event.consumer;

import com.school.mailer.PojaGenerated;
import com.school.mailer.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.school.mailer.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.school.mailer.service.event."
