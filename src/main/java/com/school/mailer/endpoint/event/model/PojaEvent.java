package com.school.mailer.endpoint.event.model;

import static com.school.mailer.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.school.mailer.PojaGenerated;
import com.school.mailer.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.school.mailer.event1";
  }
}
